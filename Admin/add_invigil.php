                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Add Invigilator To list</a>
...
<th></th>                        
                      ...
                      <tbody><?php
$time_table = mysql_query("SELECT * FROM invigilator  ORDER BY `invigilator`.`id` ASC");while($row = mysql_fetch_array($time_table, MYSQL_BOTH))
{
    $empid=$row['staff_id']
