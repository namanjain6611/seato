...
$sql="INSERT INTO members_table(roll_no,username,father_name,mother_name,password,f_name,l_name,state,city,Country,course_code,branch_code,email,m_type,pics,a_year)
VALUES
('$_POST[roll1]','$_POST[roll1]','$_POST[fadaname1]','$_POST[modaname1]','123456','$_POST[fname1]','$_POST[lname1]','$_POST[state1]','$_POST[city1]','$_POST[country1]','$_POST[course1]','$_POST[branch1]','$_POST[email1]','3','$pic','$_POST[year1]')";
...
var username = document.getElementById('modaname');
var username1= document.getElementById('modaname1');
modaname1.value=modaname.value;

var password = document.getElementById('fadaname');
var password1= document.getElementById('fadaname1');
fadaname1.value=fadaname.value;
...
$(function() {
 ...
 <select name='bookID' id='bookID' onChange="sync()" class="form-control col-md-7 col-xs-12" required ></select>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="year" class="date-picker form-control col-md-7 col-xs-12" required="required" onkeyUp='sync()' type="text">
                      ...
                      <div id="step-3">
                        <h2 class="StepTitle">Step 3 Parental Details</h2>
                        <form id="demo-form2" data-parsley-validate=""  class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
<input type="text" id="fadaname" required="required" onkeyUp='sync()'  class="form-control col-md-7 col-xs-12">  
                 </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
<input type="text" maxlength="10" id="modaname" required="required" onkeyUp='sync()'   class="form-control col-md-7 col-xs-12">                        </div>
                      </div>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
<input type="text" maxlength="10" id="mnum" required="required" onkeyUp='sync()'  class="form-control col-md-7 col-xs-12">                        </div>
                      </div>
                     </form>
  ...
  <img id="blah" height="150" width="150" src="#"/>
	...
	<input type="hidden" name="fname1" id="fname1" required >

<input type="hidden" name="lname1" id="lname1" required >

<input type="hidden" name="email1" id="email1" required >

<input type="hidden" name="state1" id="state1" required >

<input type="hidden" name="city1" id="city1" required >

<input type="hidden" name="country1" id="country1" required >  
<input type="hidden" name="roll1" id="roll1" required>

<input type="hidden" name="branch1" id="branch1" required>
<input type="hidden" name="year1" id="year1" required>

<input type="hidden" name="course1" id="course1" required >  
<input type="text" name="fadaname1" id="fadaname1" required >

<input type="text" name="modaname1" id="modaname1" required >     
