...
if(isset($_POST['sumb']))
{
mysql_query("insert into time_table(course_code,sub_name,course_id,college_id,date) values('$_POST[cname]','$_POST[sname]','$_POST[bookID]','$_POST[catID]','$_POST[edate]')");
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>TMU</span></a>
            </div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Faq <small>session</small></h2>
