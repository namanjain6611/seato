...
$query = mysql_query("SELECT * FROM settings WHERE id = '1'") or die (mysql_error()); 
 ...
 $oldem = mysql_query("SELECT * FROM members_table WHERE id='$_SESSION[adminid]'");
...
mysql_query("UPDATE members_table SET pics='$pic' WHERE  id='$_SESSION[adminid]'");
if($emailn==$_POST[emailid])
{
$m = date("Y-m-d H:i:s");

mysql_query("insert into notifications(member_id,date,n_head,msg) values('$_SESSION[adminid]','$m','Profile Updated','The Admin Profile was Succefully Updated')");
}
...
{
$m = date("Y-m-d H:i:s");
mysql_query("UPDATE members_table SET email='$_POST[emailid]' WHERE  id='$_SESSION[adminid]'");
...
{
$m = date("Y-m-d H:i:s");
mysql_query("UPDATE members_table SET mobile='$_POST[mobileid]' WHERE  id='$_SESSION[adminid]'");
...
{
mysql_query("UPDATE members_table SET password='$_POST[password]' WHERE  id='$_SESSION[adminid]'");
mysql_query("insert into notifications(member_id,date,n_head,msg) values('$_SESSION[adminid]','$m','Profile Password Changed','The Admin Profile Password was Succefully Updated')");
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img src="../images/<?php echo $_SESSION[student_pix];?>" alt="Avatar" width="220" height="220" class="img-responsive avatar-view" title="Change the avatar">                        </div>
                      </div>
                      <h3><?php echo $_SESSION['student_name'];?></h3>
<?php
 $useract = mysql_query("SELECT * FROM members_table WHERE id='$_SESSION[adminid]'");
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
							...
							<?php
 $notification = mysql_query("SELECT * FROM notifications WHERE member_id='$_SESSION[adminid]' ORDER BY `notifications`.`id` DESC limit 5");
...
$dayt=date("d",$time)
?>
                                <img src="../images/<?php echo $_SESSION[student_pix];?>" class="avatar" alt="Avatar">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate="" method="post"  enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <input type="text" id="last-name" name="last-name" value="<?php echo $college_name;?>" readonly="" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <input type="text" id="last-name" name="last-name"  value="<?php echo $course_name;?>" readonly="" class="form-control col-md-7 col-xs-12">
