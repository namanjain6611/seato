...
<div class="x_panel">
                  <div class="x_title">
                    <h2>Seat Setting Style  <small>Arrangement</small></h2>
...
function check()
{
 ...
 if(document.test.alrea.value>="1")
	{
		alert("Starting Roll Number For Slot <?php if($seatpatn>=4) {echo "SLOT C";} elseif($seatpatn>=2){echo "SLOT B";} else{echo "SLOT A";} ?> has Alrady been Assign Seat");
		return false;
	}
	
	 if(document.test.alrean.value>="1")
	{
		alert("Starting Roll Number For Slot B has Alrady been Assign Seat");
		return false;
	}
	 if(document.test.alreana.value>="1")
	{
		alert("Starting Roll Number For Slot A has Alrady been Assign Seat");
		return false;
	}
...
$(function() {
 ...
 $("#bookkID").bind("change", function() {
      var edates = $("#edates").val();
	   var shiftday = $("#shiftday").val();
	   var bookkID = $("#bookkID").val();
    $.ajax({
      type: "POST",
      url: "assignb.php",
      data: {'cattID': bookkID, 'yearadd': edates, 'shiftday': shiftday},
         success: function(html) {
             $("#alreana").html(html);
         }
     });
...
$(function() {
 ...
 $("#bookkxID").bind("change", function() {
      var edates = $("#edates").val();
	   var shiftday = $("#shiftday").val();
	   var bookkxIDD = $("#bookkxID").val();
    $.ajax({
      type: "POST",
      url: "assigna.php",
      data: {'cattID': bookkxIDD, 'yearadd': edates, 'shiftday': shiftday},
         success: function(html) {
             $("#alrean").html(html);
         }
     });
 ...
 <select name="bookxID" id="bookxID" class="form-control col-md-7 col-xs-12" required=""></select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name='ebookkxID' id='ebookkxID' onChange="sync()" required="" class="form-control col-md-7 col-xs-12"  ></select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="bookkxID" id="bookkxID" onChange="sync()" required="" class="form-control col-md-7 col-xs-12"></select>
						  <div id="alrean"></div>
                        </div>
                      </div>
                      <div class="ln_solid"></div>
...
$(function() {
 ...
 $("#bookkxIDD").bind("change", function() {
      var edates = $("#edates").val();
	   var shiftday = $("#shiftday").val();
	   var bookkxIDD = $("#bookkxIDD").val();
    $.ajax({
      type: "POST",
      url: "alreadyassign.php",
      data: {'cattID': bookkxIDD, 'yearadd': edates, 'shiftday': shiftday},
         success: function(html) {
             $("#alrea").html(html);
         }
 ...
 <select name="bookxIDD" id="bookxIDD" class="form-control col-md-7 col-xs-12" required=""></select>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Year Of Admission </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
						<select name="yearaddxx" id="yearaddxx" required="" class="form-control" > 
						<option value="">Select Sessions</option>     
						<option value="2013">2013</option>
						<option value="2014">2014</option>  
						<option value="2015">2015</option>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name='boonknID' id='boonknID' onChange="sync()" required="" class="form-control col-md-7 col-xs-12"  ></select>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Starting Roll.No <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="bookkxIDD" id="bookkxIDD" onChange="sync()" required="" class="form-control col-md-7 col-xs-12" ></select>
						 <div id="alrea"></div>
