              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
				   ...
				   echo $newmail = mysql_num_rows(mysql_query("SELECT * FROM complain WHERE reply_to='1' AND msg_read='0' ")); ?></span>
                  </a>
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                   
				     <?php
 $inbox = mysql_query("SELECT * FROM complain WHERE reply_to='1' AND msg_read='0' ORDER BY `complain`.`date` DESC limit 5");
