...
mysql_query("UPDATE complain SET msg_read='1' WHERE  id='$_GET[message_id]' AND reply_to='1'");
}
                  ...
                  <div class="x_content">
                    <div class="row">
                      <div class="col-sm-3 mail_list_column">
                        ...
                        <?php
 $inbox = mysql_query("SELECT * FROM complain WHERE reply_from='$_SESSION[staffid]' ORDER BY `complain`.`date` DESC");
                          ...
                          <div class="mail_heading row">
                            <div class="col-md-8">
                              <div class="btn-group">
                                ...
                                <button class="btn btn-sm btn-default" type="button"  data-placement="top" data-toggle="tooltip" data-original-title="Assign to Staff"><i class="fa fa-share"></i></button>
