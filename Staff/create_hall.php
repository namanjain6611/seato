...
mysql_query("insert into class_hall(name,seat_no,college_id,n_colum,n_row) values('$_POST[hall]','$b2','$_POST[catID]','$_POST[c_num]','$_POST[c_row]')");
...
<?php $result = mysql_query("SELECT * FROM college");
                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <tbody><?php
$time_table = mysql_query("SELECT * FROM class_hall WHERE college_id='$_SESSION[college_id]' ORDER BY `class_hall`.`id` ASC");while($row = mysql_fetch_array($time_table, MYSQL_BOTH))
{
?>
                        <tr>
...
?></td>
						  ...
						  <td> <a href="seat_view.php?seats=<?php echo $row['id'];?>"><button id="send" type="submit" class="btn btn-primary"><i class="fa fa-eye"></i> view</button></a></td>
