...
<html lang="en">
  <head>
    ...
    <title><?php echo $display['site_name'] ?> | Staff Dashboard</title>
            ...
            <div class="row top_tiles">
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><?php $m = date("Y-m-d H:i:s");
				   echo $totaluser = mysql_num_rows(mysql_query("SELECT * FROM  members_table WHERE m_type='3' AND branch_code='$_SESSION[college_id]' ORDER BY `members_table`.`id` DESC")); ?></div>
                  <h3>No Of Student</h3>
                  <p>.</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><?php $m = date("Y-m-d H:i:s");
				   echo $totaluser = mysql_num_rows(mysql_query("SELECT * FROM  time_table WHERE college_id='$_SESSION[college_id]' ORDER BY `time_table`.`id` DESC")); ?></div>
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><?php
				   echo $newmail = mysql_num_rows(mysql_query("SELECT * FROM complain WHERE reply_to='$_SESSION[staffid]' AND msg_read='0' ")); ?></div>
                  <h3>New Mail</h3>
                  <p>.</p>
                </div>
              </div>
			  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <div class="icon"><i class="fa fa-sort-amount-desc"></i></div>
                  <div class="count"><?php
				   echo $newmail = mysql_num_rows(mysql_query("SELECT * FROM complain WHERE assign_to='$_SESSION[staffid]' AND msg_read='0' ")); ?></div>
                  <h3>Assigned Mails</h3>
                  <p>.</p>
                </div>
              </div>
          <div class="row">
...
?></p>
                      ...
                      <div class="media-body">
                        ...
                        <p><strong><?php echo $row['sub_name'];?></strong> paper Will be writen on <?php echo $row['date'];?></p>
                      </div>
                    </article>
                    <?php }?>
                     </div>
