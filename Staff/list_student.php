...
{
 mysql_query("DELETE FROM members_table WHERE id = '$_GET[delete]'");
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<?php echo $error; ?>
                  <div class="x_title">
                    <h2>Student List <small>Active</small></h2>
...
List Of Active Student In Database.
                    </p>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody><?php
$time_table = mysql_query("SELECT * FROM members_table WHERE m_type='3' AND branch_code='$_SESSION[college_id]' ORDER BY `members_table`.`roll_no` ASC");while($row = mysql_fetch_array($time_table, MYSQL_BOTH))
{
?>
                        <tr>
...
?></td>
						  ...
						  <td><button id="send" type="submit" class="btn btn-primary"><i class="fa fa-eye"></i> View</button><button id="send" type="submit" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</button> <script type="text/javascript">
