...
mysql_query("UPDATE members_table SET rec_sms='$_POST[rec_sms]' WHERE  id='$_SESSION[staffid]'");
mysql_query("UPDATE members_table SET rec_email='$_POST[rec_email]' WHERE  id='$_SESSION[staffid]'");
$m = date("Y-m-d H:i:s");

mysql_query("insert into notifications(member_id,date,n_head,msg) values('$_SESSION[staffid]','$m','User Notification Set','The Student Profile Notifications was Succefully Updated and set')");
