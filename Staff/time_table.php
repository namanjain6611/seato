...
<th></th>                        
                      ...
                      <tbody><?php
$time_table = mysql_query("SELECT * FROM time_table WHERE college_id='$_SESSION[college_id]'  ORDER BY `time_table`.`date` ASC");while($row = mysql_fetch_array($time_table, MYSQL_BOTH))
{
?>
                        <tr>
