...
$s_detail = mysql_query("SELECT * FROM members_table WHERE id='$_SESSION[studentid]'");
while($row = mysql_fetch_array($s_detail, MYSQL_BOTH))
{
 $f_name =$row['f_name'];
 $l_name =$row['l_name'];
  $roll_no =$row['roll_no'];
  $fada_name =$row['father_name'];
...
<div align="center">
  <table width="1021" border="0">
    <tr>
      <td width="297" rowspan="4"><div align="left"><img src="../images/<?php echo $display['site_logo'] ?>" alt="..." width="140" height="110" >&nbsp;</div></td>
      <td width="416" height="51"><div align="center"><h3><strong><?php echo $display['site_full_name'] ?> </strong></h3></div></td>
      <td width="294" rowspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td height="32"><div align="center"><strong>ADMIT CARD </strong></div></td>
      </tr>
    <tr>
  ...
  <tr>
    ...
    <td rowspan="7"><div align="right"><img src="../images/<?php echo $_SESSION[student_pix];?>" alt="..." width="150" height="150"></div></td>
  </tr>
  <tr>
    <td><span class="style11"><strong>Enrolment No. </strong></span></td>
    <td><span class="style11"><strong>: &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $roll_no;?></strong></span></td>
  </tr>
  <tr>
    <td><span class="style11"><strong>Student's Name </strong></span></td>
    <td><span class="style11"><strong>:   &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $f_name;?> &nbsp;   <?php echo $l_name;?>   </strong></span></td>
  </tr>
  <tr>
    <td><span class="style11"><strong>Father's Name </strong></span></td>
    <td><span class="style11"><strong>:  &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $fada_name;?></strong></span></td>
  </tr>
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>  <?php
$time_table = mysql_query("SELECT * FROM time_table WHERE college_id='$_SESSION[college_id]' AND course_id='$_SESSION[course_code]' AND year='$_SESSION[year]' ORDER BY `time_table`.`date` ASC");
...
?>
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $row['sub_name'];?> <i class="success fa fa-long-arrow-up"></i></td>
