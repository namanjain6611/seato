...
mysql_query("UPDATE complain SET msg_read='1' WHERE  id='$_GET[message_id]' AND reply_to='$_SESSION[studentid]'");
}
...
{
$m = date("Y-m-d H:i:s");
mysql_query("insert into complain(member_id,reply_to,reply_from,message,date,msg_sub) values('$_SESSION[studentid]','1','$_SESSION[studentid]','$_POST[contentn]','$m','$_POST[from]')");
...
mysql_query("insert into complain(member_id,reply_to,reply_from,message,date,msg_sub) values('$_SESSION[studentid]','$_POST[msto]','$_SESSION[studentid]','$_POST[content]','$m','$_POST[subject]')");
                  ...
                  <div class="x_content">
                    <div class="row">
                      <div class="col-sm-3 mail_list_column">
                        ...
                        <?php
 $inbox = mysql_query("SELECT * FROM complain WHERE reply_to='$_SESSION[studentid]' OR reply_from='$_SESSION[studentid]' AND send_del='0' ORDER BY `complain`.`date` DESC");
