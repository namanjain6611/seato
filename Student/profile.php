...
$query = mysql_query("SELECT * FROM settings WHERE id = '1'") or die (mysql_error()); 
 ...
 $oldem = mysql_query("SELECT * FROM members_table WHERE id='$_SESSION[studentid]'");
...
mysql_query("UPDATE members_table SET pics='$pic' WHERE  id='$_SESSION[studentid]'");
if($emailn==$_POST[emailid])
{
$m = date("Y-m-d H:i:s");

mysql_query("insert into notifications(member_id,date,n_head,msg) values('$_SESSION[studentid]','$m','Profile Updated','The Student Profile was Succefully Updated')");
}
...
{
$m = date("Y-m-d H:i:s");
mysql_query("UPDATE members_table SET email='$_POST[emailid]' WHERE  id='$_SESSION[studentid]'");
...
{
$m = date("Y-m-d H:i:s");
mysql_query("UPDATE members_table SET mobile='$_POST[mobileid]' WHERE  id='$_SESSION[studentid]'");
...
{
mysql_query("UPDATE members_table SET password='$_POST[password]' WHERE  id='$_SESSION[studentid]'");
mysql_query("insert into notifications(member_id,date,n_head,msg) values('$_SESSION[studentid]','$m','Profile Password Changed','The Student Profile Password was Succefully Updated')");
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
							...
							<?php
 $notification = mysql_query("SELECT * FROM notifications WHERE member_id='$_SESSION[studentid]' ORDER BY `notifications`.`id` DESC limit 5");
