...
Print Your exam Time table to know the date and shedule of ur exams and date with seat allocated To you.
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody><?php
$time_table = mysql_query("SELECT * FROM time_table WHERE college_id='$_SESSION[college_id]' AND course_id='$_SESSION[course_code]' AND year='$_SESSION[year]' ORDER BY `time_table`.`date` ASC");while($row = mysql_fetch_array($time_table, MYSQL_BOTH))
{
?>
                        <tr>
