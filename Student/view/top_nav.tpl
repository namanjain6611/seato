              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../images/<?php echo $_SESSION[student_pix];?>" alt=""><?php echo $_SESSION[student_name];?>                    <span class=" fa fa-angle-down"></span>
                  </a>
                ...
                <li role="presentation" class="dropdown">
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
				   ...
				   echo $newmail = mysql_num_rows(mysql_query("SELECT * FROM complain WHERE reply_to='$_SESSION[studentid]' AND msg_read='0' ")); ?></span>
                  </a>
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                   
				     <?php
 $inbox = mysql_query("SELECT * FROM complain WHERE reply_to='$_SESSION[studentid]' ORDER BY `complain`.`date` DESC limit 5");
